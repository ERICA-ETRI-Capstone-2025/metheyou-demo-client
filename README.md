...
| 이름       | 소속              | 역할               |
|------------|-------------------|--------------------|
| 양승언   | 컴퓨터학부   | 팀 ETRICA 리더, 웹앱 개발 |
| 박동준 | 컴퓨터학부   | 웹앱 개발, 코드 리뷰    |
| 도기훈   | 인공지능학과   | 모델 개발, 자료 정리 및 테스트 |
| 박정민   | 수리데이터사이언스학과   | 모델 개발, 데이터 수집 및 전처리 |
| 김동현   | 수리데이터사이언스학과   | 모델 개발, 데이터 수집 및 전처리 |

사실 그런건 없구요 멘토님이랑 클로드 그리고 동준씨의 눈물이 모든것을 해결했습니다 -무려 팀 리더 되시는 양승언-
